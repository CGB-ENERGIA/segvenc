...
const ICONES: Record<string, string> = {
  ...
  '/funcionarios':  'M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2 M9 11a4 4 0 100-8 4 4 0 000 8 M23 21v-2a4 4 0 00-3-3.87 M16 3.13a4 4 0 010 7.75',
  '/colaboradores': 'M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z M14 2v6h6 M16 13H8 M16 17H8 M10 9H8',
...
export default function Sidebar() {
  ...
  useEffect(() => {
    ...
    if (salvo === 'true') setRecolhida(true)
  }, [])
  ...
  const itensFiltrados = usuario
    ? todosItens.filter(item => item.niveis.includes(usuario.nivel))
    : todosItens
  ...
  return (
    <div style={{
        ...
        <div style={{
          ...
          {recolhida && (
            <img src="/logo-cgb.png" alt="CGB" style={{ height: 24 }} />
          )}
